...
import {
  ...
  Quarter,
  Year,
} from "../models/artifact-meta-models.ts";
import type StoreModel from "../models/store-model.tsx";
...
const useStateStoreBase = create<StoreModel>()((set, get) => ({
  ...
  uploadArtifactMetas: (file: File) => {
    ...
    reader.onload = (event) => {
      const artifactMetas = JSON.parse(
  ...
  downloadArtifactMetas: () => {
    const blob = new Blob([JSON.stringify(get().artifactMetas)], {
  ...
  setImageThumbnailSrc: (index: number, src: string) => {
    ...
    set((state) => {
      ...
      newArtifactMetas[currentArtifactIndex].images[index].thumbnailSrc =
        assetPath;
  ...
  setImageDescription: (index: number, description: string) => {
    set((state) => {
      ...
      newArtifactMetas[currentArtifactIndex].images[index].description =
        description;
  ...
  setLinkDescription: (index: number, description: string) => {
    set((state) => {
      ...
      newArtifactMetas[currentArtifactIndex].links[index].description =
        description;
