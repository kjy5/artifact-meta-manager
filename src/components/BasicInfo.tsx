  ...
  return (
    <Stack spacing={1}>
      ...
      <TextField
        ...
        onChange={useCallback(
          (event: ChangeEvent<HTMLInputElement>) => {
            setArtifactYear(Number.parseInt(event.target.value));
          },
          [setArtifactYear],
        )}
      >
      ...
      <TextField
        ...
        label={"Quarter"}
        value={
          currentArtifact.quarter === Quarter.None
            ? ""
            : currentArtifact.quarter
        }
        onChange={useCallback(
          (event: ChangeEvent<HTMLInputElement>) => {
            setArtifactQuarter(Number.parseInt(event.target.value));
          },
          [setArtifactQuarter],
        )}
      >
